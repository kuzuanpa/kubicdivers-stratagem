...
public class GunSentryEntity extends AbstractSentryEntity {
    public GunSentryEntity(EntityType<? extends GunSentryEntity> type, Level level) {
        super(type, level);
    }

    public GunSentryEntity(Level level) {
        super(ModEntities.GUN_SENTRY.get(), level);
    }


    @Override protected int getFireRate() { return 5; } // 极快，2tick一发
