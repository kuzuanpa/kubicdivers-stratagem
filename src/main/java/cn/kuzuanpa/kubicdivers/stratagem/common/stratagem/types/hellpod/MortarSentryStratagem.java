...
import cn.kuzuanpa.kubicdivers.stratagem.common.entity.sentry.MortarSentryEntity;
...
public class MortarSentryStratagem extends AbstractHellpodStratagem {
    @Override
    public String getId() {
        return "mortar_sentry";
    }

    @Override
    public String getName() {
        return "Mortar Sentry";
    }
    ...
    public @Nullable ResourceLocation getIcon() {
        return ResourceLocation.fromNamespaceAndPath(KubicdiversStratagemMod.MOD_ID, "textures/gui/stratagem/mortar_sentry.png");
    }
    @Override
    ...
    public Entity createEntityOnPod(Level level, Vec3 padPos) {
        AbstractSentryEntity sentry = new MortarSentryEntity(level);
