...
public class OrbitalBulletRenderer extends EntityRenderer<AbstractArrow> {
    private static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath( MOD_ID, "textures/entity/orbital_bullet.png");

    public OrbitalBulletRenderer(EntityRendererProvider.Context context) {
        super(context);
    }
    ...
    public void render(AbstractArrow entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        ...
        poseStack.scale(1.0F, 0.4F, 0.4F);
